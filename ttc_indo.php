...
echo $white." ⏩ ".$green."Masukkan Cookies TTC : ";
$cc =trim(fgets(STDIN));
fwrite($my,$cc);
    $my = file("logttc.txt");
...
if ($chedo<7){
for($b=1;$b<=$luong;$b++){
    echo $white." + ".$green."Masukkan Cookies ".$thu.":$white ";
...
if (explode('\",\"useLocalFilePreview',explode('accessToken\":\"', $access)[1])[0])
{
        array_push($mangcookie,$cookie);
               $c++;
              $thu++;
}else{echo $white." ⛔ ".$red."Cookies Mati Coba Lagi \n";$b--;}
}
}else{
  for($b=1;$b<=$luong;$b++){
...
if($luong==1){
  nhiemvu:
  echo $white." ⏩ ".$blue."Setelah berapa banyak misi, ubah jenis tugas: $white ";
} else{
$dl = 150;
echo $white." ⏩ ".$blue."Setelah banyak tugas, ubah konfigurasi: $white ";
}
...
$listnv = [];
  Job:
  echo $yellow." ⏩ ".$blue."Misi Follow$pink (on/off): $white";
  $chon1=trim(fgets(STDIN));
  if ($chon1 == 'on' or $chon1 == 'On' or $chon1 == 'ON'){
    array_push($listnv,'sub');
  }
  echo $yellow." ⏩ ".$blue."Misi Like$pink (on/off): $white";
  ...
  if ($chedo <7){
  echo $yellow." ⏩ ".$blue."Misi Like Page$pink (on/off): $white";
  $chon4=trim(fgets(STDIN));
  if ($chon4 == 'on' or $chon4 == 'On' or $chon1 == 'ON' ){
    array_push($listnv,'page');
  }
  echo $yellow." ⏩ ".$blue."Misi Share$pink (on/off): $white";
  ...
  if (count($listnv) == 0){
    echo $red."Pilih Minimal 1 Jenis !\n";
    GOTO Job;
  }
  Time_nv:
  echo $yellow." ⏩ ".$blue."Delay Misi: $white";
  $timedelay=trim(fgets(STDIN));
  if($timedelay < 1)
    {
      echo $red."\033[1;37m~\033[1;31m Delay Misi !\n";
      GOTO Time_nv;
    }
usleep(200000);
...
while($i<10){
  ...
  if ($rand == 'like'){
    ...
    if($check==0){
      echo "                                                      \r";
     echo $white." ❌ ".$red."Selesai Misi Like\r";
    }
    foreach ($list  as $id) {
    $id = $id[("idpost")];
  ...
  if ($rand == 'sub'){
    ...
    if($check==0){
      echo "                                                      \r";
     echo $white." ❌ ".$red."Selesai Misi Follow\r";
    }
    foreach ($list  as $id) {
    $id = $id[("idpost")];
  ...
  if ($rand == 'cmt'){
    ...
    if($check==0){
      echo "                                                      \r";
     echo $white." ❌ ".$red."Selesai Misi Comment\r";
    }
  ...
  $list = getnv($cc,$loai,$useragent);
    ...
    if($check==0){
      echo "                                                      \r";
     echo $white." ❌ ".$red."Selesai Misi Like Page\r";
    }
    foreach ($list  as $id) {
    $id = $id[("idpost")];
    $g = page($id,$cookie);
  ...
  if ($rand == 'cx'){
    ...
    if($check==0){
      echo "                                                      \r";
     echo $white." ❌ ".$red."Selesai Misi Share\r";
    }
    foreach ($list  as $id => $key) {
    $id = $key[("idpost")];
    $type = $key[("loaicx")];
...
echo $pink." ⏩ ".$blue."Masukan ID Facebook : ";
$luong=trim(fgets(STDIN));
if ($luong<1){exit($red."\033[1;37m~\033[1;31m Pilihan Salah\n");}
}
$c=1;$thu=1;
if ($chedo<7){
for($b=1;$b<=$luong;$b++){
...
if(json_decode(file_get_contents('https://graph.facebook.com/me/?access_token='.$access_token))->{'id'}){
  ...
  echo $white." ⛔ ".$red."Token Salah, Silahkan Cek Lagi\n";$b--;
}
} 
}
if (count($mangcookie)==1 && empty($dl)){
...
function loadtime($time){
        for ( $x = $time; $x--; $x ) {
echo "                                                      \r";
echo " Mohon Tunggu \e[1;31m- \e[1;32m- \e[1;33m- \e[1;34m- \e[1;35m- \e[1;37m ".$x."\033[1;37m \e[1;33m !!!";
usleep(170000);
echo "\r";
echo "                                                      \r";
echo " Mohon Tunggu \e[1;33m- \e[1;34m- \e[1;35m- \e[1;36m- \e[1;31m- \e[1;37m ".$x."\033[1;37m \e[1;34m !!!";
       usleep(170000);
       echo "\r";
       echo "                                                      \r";
       echo " Mohon Tunggu \e[1;34m- \e[1;35m- \e[1;36m- \e[1;31m- \e[1;33m- \e[1;37m ".$x."\033[1;37m \e[1;31m !!!";
       usleep(170000);
       echo "\r";
       echo "                                                      \r";
       echo " Mohon Tunggu \e[1;35m- \e[1;36m- \e[1;31m- \e[1;33m- \e[1;34m- \e[1;37m ".$x."\033[1;37m \e[1;32m !!!";
       usleep(170000);
       echo "\r";
       echo "                                                      \r";
       echo " Mohon Tunggu \e[1;33m- \e[1;32m- \e[1;31m- \e[1;35m- \e[1;36m-\e[1;37m ".$x."\033[1;37m \e[1;36m !!!";
       usleep(170000);
       echo "\r";
}
}
...
for ( $x = $time; $x--; $x ) {
echo "                                                      \r";
echo "\e[1;32mMohon Tunggu \e[1;37m \e[1;31m- \e[1;32m- \e[1;33m- \e[1;34m- \e[1;35m- \e[1;37m ".$x."\033[1;37m \e[1;33m !!!";
usleep(170000);
echo "\r";
echo "                                                      \r";
echo "\e[1;36mMohon Tunggu \e[1;37m \e[1;33m- \e[1;34m- \e[1;35m- \e[1;36m- \e[1;31m- \e[1;37m ".$x."\033[1;37m \e[1;34m !!!";
       usleep(170000);
       echo "\r";
       echo "                                                      \r";
       echo "\e[1;34mMohon Tunggu \e[1;37m \e[1;34m- \e[1;35m- \e[1;36m- \e[1;31m- \e[1;33m- \e[1;37m ".$x."\033[1;37m \e[1;31m !!!";
       usleep(170000);
       echo "\r";
       echo "                                                      \r";
       echo "\e[1;33mMohon Tunggu \e[1;37m \e[1;35m- \e[1;36m- \e[1;31m- \e[1;33m- \e[1;34m- \e[1;37m ".$x."\033[1;37m \e[1;32m !!!";
       usleep(170000);
       echo "\r";
       echo "                                                      \r";
       echo "\e[1;31mMohon Tunggu \e[1;37m \e[1;33m- \e[1;32m- \e[1;31m- \e[1;35m- \e[1;36m-\e[1;37m ".$x."\033[1;37m \e[1;36m !!!";
       usleep(170000);
       echo "\r";
